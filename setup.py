...
from basecon import __author__, __license__, __version__
...
setup(
  name = 'BaseCon',
  version = __version__,
  description = 'Python BaseCon library for converting integers to URL safe strings.',
  long_description = PROJECT_README,
  url = 'https://www.github.com/copyrighthero/BaseCon',
